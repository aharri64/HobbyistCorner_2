...
router.get('/me', auth, async (req, res) => {
    ...
    //? .populate brings in attributes from the referenced model
        if (!profile) {
...
//! access: Private
router.post('/', auth,
    check('currentProject', 'currentProject is required').notEmpty(), //! might not work
...
router.put('/projects', auth,
    ...
    check('genre', 'Hobby genre is required').notEmpty(),
